...
YOUTUBE_SELECTOR_SUBSUBSYSTEM = ChatMessage(
    ...
    YOU CAN ONLY CHOSE VIDEO(S) FROM THE STRUCTURED DATA PRESENTED TO YOU.

    Please prefer multiple videos rather than a single one, unless it is really the best choice.
